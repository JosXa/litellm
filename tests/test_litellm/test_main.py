...
def test_responses_api_bridge_check_github_copilot_gpt_5_4_tools_routes_to_responses():
    """GitHub Copilot gpt-5.4 tool turns must bridge to Responses API."""
    from litellm.main import responses_api_bridge_check
...
def test_responses_api_bridge_check_github_copilot_gpt_5_4_tools_plus_reasoning_routes_to_responses():
    """GitHub Copilot gpt-5.4 with tools + reasoning also bridges to Responses."""
    from litellm.main import responses_api_bridge_check
